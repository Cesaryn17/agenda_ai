...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='imagem',
            constraint=models.UniqueConstraint(condition=models.Q(('capa', True), ('servico__isnull', False)), fields=('servico', 'capa'), name='unique_capa_servico'),
        ),
        migrations.AddConstraint(
            model_name='imagem',
            constraint=models.UniqueConstraint(condition=models.Q(('anuncio__isnull', False), ('capa', True)), fields=('anuncio', 'capa'), name='unique_capa_anuncio'),
        ),
    ]
